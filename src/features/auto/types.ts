...
export interface AccountContext {id:string;requestedMode:AutoMode;commerceReady:boolean;providerAvailable:boolean;analyticsFresh:boolean;accountHealthy:boolean;consent:boolean;publishRemaining:number;desiredCandidates:number;desiredPosts:number;priority:number;nextGrowthAction?:string;affiliateDecision?:"SCALE"|"WATCH"|"STOP"|"INSUFFICIENT_DATA";}
