...
export type BenchmarkModel="gen4_turbo"|"h3_max_768"|"wan3_720"|"hailuo3_768"|"gen4.5";
...
export interface TechnicalEvaluation {passed:boolean;score:number;checks:{duration:boolean;portrait:boolean;resolution:boolean;videoCodec:boolean;nonEmpty:boolean};media:RenderedVideo}
export interface HumanScores {productIdentity:number;motionRealism:number;promptAdherence:number;commerceClarity:number;artifactControl:number;visualPolish:number}
