...
export function RecommendationTable({scores,input}:{scores:PairScore[];input:AssignmentInput}) {
  ...
  return <div className="radar-table-wrap"><table className="radar-table">
    <thead><tr><th>Product</th><th>Category</th><th>Product Momentum</th><th>Category Momentum</th><th>Account Affinity</th><th>Account Fit</th><th>Final Opportunity</th><th>Reason</th></tr></thead>
