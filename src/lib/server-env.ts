...
const serverEnvSchema = z.object({
  ...
  TIKTOK_OAUTH_SCOPE_MODE: z.enum(["basic", "publishing"]).default("publishing"),
...
const parsed = serverEnvSchema.safeParse({
  ...
  TIKTOK_OAUTH_SCOPE_MODE: process.env.TIKTOK_OAUTH_SCOPE_MODE,
...
export const serverEnv = Object.freeze({
  ...
  tiktokOAuthScopeMode: parsed.data.TIKTOK_OAUTH_SCOPE_MODE,
