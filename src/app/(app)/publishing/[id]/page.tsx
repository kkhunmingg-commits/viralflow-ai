...
import { cancelPublishAction, consentPublishAction, fetchPublishStatusAction, preparePublishAction, retryPublishAction, schedulePublishAction, sendPublishAction } from "../actions";
...
export default async function PublishingDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { queue, account, attempts, events, consents } = detail;
